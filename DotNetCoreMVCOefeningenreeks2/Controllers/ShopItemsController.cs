...
namespace DotNetCoreMVCOefeningenreeks2.Controllers
{
    ...
    {
        private readonly MyShopLiContext _context;

        public ShopItemsController(MyShopLiContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Item,Quantity")] ShopItem shopItem)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var shopItem = await _context.ShopItem.SingleOrDefaultAsync(m => m.Id == id);
            if (shopItem == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Item,Quantity")] ShopItem shopItem)
        {
            if (id != shopItem.Id)
            {
                return NotFound();
